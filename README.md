1. Introduction
----------------
This codebook describes data and the operation taken to cleanse that data.
...
The script removes all columns that do not contain standard deviation (std), mean values or activity/subject id.

Last step is to write a file named "tidyOutputSet.txt" with "," as separator.
b
